								...
								<div class="card mb-3">
									...
									<div class="card-body">
										<form action="data-search.php" method="GET">
											<div class="mb-3">
												<label for="search" class="form-label">Masukkan No atau Nama Karyawan</label>
												<input type="text" class="form-control" id="search" name="search" placeholder="Cari berdasarkan NO atau Nama Karyawan" value="<?php echo $kataKunci; ?>" required>
											</div>
												...
												echo '<table class="table table-striped" role="table">
													...
													foreach ($cariKaryawan as $index => $karyawan){
														...
														if($karyawan['status'] == 1){
															...
															$karyawan['status'] = '<span class="badge bg-warning text-dark">Cuti Kerja</span>';
														} elseif($karyawan['status'] == 4){
															$karyawan['status'] = '<span class="badge bg-primary">Berhenti Kerja</span>';
														} 
